...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [DV] = KEYMAP(
             ...
             M_LSFT,  KC_NO,KC_SCLN,   KC_Q,   KC_J,   KC_K,   KC_X,   KC_B,   KC_M,   KC_W,   KC_V,   KC_Z, M_RSFT, KC_DEL,   KC_UP,\
            KC_LCTL,KC_LGUI,KC_LALT,                 KC_SPC,                                KC_RALT, MO(FN),KC_LEFT,KC_DOWN,KC_RIGHT),
    // 1: QWERTY Layer
    [QW] = KEYMAP(
             ...
             M_LSFT,  KC_NO,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,KC_COMM, KC_DOT,KC_SLSH,M_RSFT , KC_DEL,   KC_UP,\
            KC_LCTL,KC_LGUI,KC_LALT,                 KC_SPC,                                KC_RALT, MO(FN),KC_LEFT,KC_DOWN,KC_RIGHT),
    ...
    [SY] = KEYMAP(
            _______,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9, KC_F10,KC_F11,  KC_F12,_______,_______,\
            _______,_______,_______,_______,KC_LPRN,_______,_______,KC_RPRN,_______,_______,_______,_______,_______,        _______,\
            _______,_______,_______,_______,KC_LCBR,_______,_______,KC_RCBR,_______,_______,_______,_______,_______,        _______,\
            _______,_______,_______,_______,KC_LBRC,_______,_______,KC_RBRC,_______,_______,_______,_______,_______,_______,_______,\
